...
class OperariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operario" do
    assert_difference('Operario.count') do
      post operarios_url, params: { operario: { Sueldo: @operario.Sueldo, SueldoHora: @operario.SueldoHora, TipoOperario: @operario.TipoOperario } }
    end
  ...
  test "should update operario" do
    patch operario_url(@operario), params: { operario: { Sueldo: @operario.Sueldo, SueldoHora: @operario.SueldoHora, TipoOperario: @operario.TipoOperario } }
